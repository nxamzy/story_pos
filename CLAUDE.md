...
- Still owned by the user, not the code: the upload keystore (`android/key.properties`), deploying the two public pages, screenshots, and the Play Console Data safety / content-rating forms — see `android/RELEASE.md` §6.
