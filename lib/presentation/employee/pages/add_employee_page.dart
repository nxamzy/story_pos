...
class _EmployeeAddPageState extends State<EmployeeAddPage> {
  ...
  final roleController = TextEditingController(text: "Xodim");
      ...
      child: Column(
        children: [
          ...
          _HeavyDutyTextField(
            ...
            hint: "Qo'lidagi boshlang'ich naqd pul",
